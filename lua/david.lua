...
vim.keymap.set(
	...
	"<C-x>",
	":x<CR>",
	{ desc = "e[x]it window: close the active window" }
)
...
vim.keymap.set(
	"i",
	"ierrn",
	"if err != nil {<Enter>\treturn nil, err<Enter><Backspace>}<Esc>"
)
...
vim.keymap.set(
	...
	"<leader>ew",
	':e <C-R>=expand("%:p:h") . "/"<CR>',
	{ desc = "[e]dit file in current [w]indow" }
)
vim.keymap.set(
	"n",
	"<leader>es",
	':sp <C-R>=expand("%:p:h") . "/"<CR>',
	{ desc = "[e]dit file in [s]plit" }
)
vim.keymap.set(
	"n",
	"<leader>ev",
	':vsp <C-R>=expand("%:p:h") . "/"<CR>',
	{ desc = "[e]dit file in [v]ertical split" }
)
vim.keymap.set(
	"n",
	"<leader>et",
